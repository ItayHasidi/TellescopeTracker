...
#everythin in degrees
    ...
    telescopeY_Speed = 0;
# /dev/ttyUSB0 /dev/tty0
    def __init__(self,port="COM9", baudrate="9600", mindx=10, mindy=10,maxdx=1000, maxdy=1000):
        tr.Thread.__init__(self);
        self.ser = serial.Serial(port, baudrate)  # need to check the com

        self.ser = serial.Serial()
        self.ser.port = "COM9"  # may be called something different  /dev/ttyUSB1
    ...
    def initProtocol(self):
        self.midLeft = chr(80) + chr(2) + chr(16) + chr(37) + chr(50) + chr(142) + chr(56) + chr(0)  # go left slow speed
        self.midRight = chr(80) + chr(2) + chr(16) + chr(36) + chr(50) + chr(142) + chr(56) + chr(0)  # going right at speed of 4
        ...
        # 5th chr(0) means stop and chr(6) means very slow
